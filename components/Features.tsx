...
export const Features = () => {
  return (
    <section id="features" className="bg-black pb-52 text-white">
        ...
        <div className="grid h-[135dvh] w-full grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              ...
              <TiLocationArrow className="m-5 scale-[30] self-end text-black" />
            </div>
          </BentoTilt>

          <BentoTilt className="bento-tilt_2">
            <OptimizedVideo
              src="https://res.cloudinary.com/dqyzd8vqh/video/upload/v1780585133/BENTO_4_rwiwxu.mp4"
              autoPlay
              loop
              muted
              className="size-full object-cover object-center"
